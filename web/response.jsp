...
<html>
    ...
    <body>
        <jsp:useBean id="staffIDbean" scope="session" class="org.mypackage.login.DetailHandler" />
        ...
        <jsp:useBean id="passwdbean" scope="session" class="org.mypackage.login.DetailHandler" />
